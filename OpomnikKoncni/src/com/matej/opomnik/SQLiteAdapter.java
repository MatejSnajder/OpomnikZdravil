...
public Cursor vrniCaseNaDatum(String dan, String mesec, String leto)
{
	Cursor c = sqLiteDatabase.query(MYDATABASE_TABLE, new String[]{TABELA_STOLPEC_CAS_JEMANJA_ZDRAVILA, TABELA_STOLPEC_KOLICINA_NA_DAN, TABELA_STOLPEC_OPOMIN, TABELA_STOLPEC_NAZIV_ZDRAVILA, TABELA_STOLPEC_DATUM},
			"tabela_stolpec_datum = ?", new String[] {dan+"."+mesec+"."+leto}, null, null, null);
